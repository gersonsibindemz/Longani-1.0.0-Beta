    ...
    <main className="flex-grow flex items-center justify-center p-4">
      <div className="w-full max-w-sm mx-auto animate-fade-in-up">
        ...
        <div className="bg-white/60 dark:bg-gray-800/60 rounded-2xl shadow-lg p-6 md:p-8 border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
          <h1 className="text-2xl font-bold text-center text-gray-800 dark:text-gray-200 mb-6">Aceder à sua conta</h1>
          <form onSubmit={handleLogin} noValidate>
            ...
            <div className="mt-6">
              ...
              >
                {isLoading ? <Loader className="w-5 h-5" /> : 'Entrar'}
              </button>
            </div>
          </form>
          <p className="mt-6 text-center text-xs text-gray-500 dark:text-gray-400">
            Ainda não tem conta? <a href="#" className="font-medium text-[#24a9c5] hover:underline">Cadastre-se</a>
          </p>
        </div>
      </div>
    </main>
